...
function fetchData() {
    infoTxt.innerText = 'Obteniendo información climática...';
...
function weatherDetails(info) {
    if (info.cod == '404') {
        ...
        if (id == 800) {
            wIcon.src = 'imagenes/api-rest-img/clear.png';
        } else if (id >= 200 && id <= 232) {
            wIcon.src = 'imagenes/api-rest-img/storm.png';
        } else if (id >= 600 && id <= 622) {
            wIcon.src = 'imagenes/api-rest-img/snow.png';
        } else if (id >= 701 && id <= 781) {
            wIcon.src = 'imagenes/api-rest-img/haze.png';
        } else if (id >= 801 && id <= 804) {
            wIcon.src = 'imagenes/api-rest-img/cloud.png';
        } else if ((id >= 300 && id <= 321) || (id >= 500 && id <= 531)) {
            wIcon.src = 'imagenes/api-rest-img/rain.png';
        }
